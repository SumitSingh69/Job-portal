...
const JobDetails = () => {
  ...
  const toggleSaveJob = () => {
    ...
    const tempMsg = !saved ? "Job saved to your profile" : "Job removed from saved jobs";
  ...
  const shareJob = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: `Check out this job opportunity: ${job.title} at ${job.companyId?.name || "Company"}`,
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-6 flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="text-lg font-medium text-blue-700">Loading job details...</div>
          <p className="text-sm text-blue-400 mt-2">Fetching the perfect opportunity for you</p>
        </motion.div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 p-6 flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="text-xl font-medium text-red-600 mt-4">{error || "Job not found"}</div>
          <p className="text-red-400 mt-2">Please try again or explore other job listings</p>
        </motion.div>
      </div>
    );
  }
              ...
              <div className="ml-0 sm:ml-20 mt-4 sm:mt-0">
                ...
                >
                  {job.companyId && job.companyId.name && (
                    <span className="font-medium text-indigo-700">{job.companyId.name}</span>
                  )}
            ...
            >
              ...
              <div className="flex gap-3">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`${saved ? 'bg-indigo-100 text-indigo-700 border-indigo-200' : 'bg-white border-gray-200 text-gray-700 hover:border-gray-300'} border py-3 px-4 rounded-lg text-base font-medium transition-all duration-300 shadow-sm hover:shadow flex items-center justify-center`}
                >
                  <svg className={`w-5 h-5 ${saved ? 'text-indigo-500 fill-indigo-500' : 'text-gray-500'}`} 
            ...
            {applyMessage && (
              <motion.div 
                ...
                className={`mt-4 p-3 rounded-lg text-center ${
                  hasApplied || saved ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                }`}
              >
                {applyMessage}
              </motion.div>
              ...
              <div className="relative">
                ...
                <div className="flex mb-8 relative">
                  ...
                  <div className="ml-4 pt-3">
                    <h5 className="text-lg font-semibold text-indigo-700">Application Deadline</h5>
                    <p className="text-indigo-600">{formatDate(job.applicationDeadline)}</p>
                  </div>
                </div>
                ...
                <div className="flex mb-8 relative">
                  ...
                  <div className="ml-4 pt-3">
                    <h5 className="text-lg font-semibold text-blue-700">Screening Process</h5>
                    <p className="text-blue-600">1-2 weeks after application deadline</p>
                  </div>
                </div>
                ...
                <div className="flex relative">
                  ...
                  <div className="ml-4 pt-3">
                    <h5 className="text-lg font-semibold text-green-700">Expected Start Date</h5>
                    <p className="text-green-600">Within 4 weeks after selection</p>
                  </div>
                </div>
              </div>
            </motion.div>
                ...
                <div className="text-center md:text-left">
                  {job.companyId.logo && (
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-100 to-indigo-100 mx-auto md:mx-0 flex items-center justify-center rounded-full border-2 border-blue-200 shadow-md mb-4">
                      <img src={job.companyId.logo} alt={job.companyId.name} className="w-16 h-16 object-cover rounded-full" />
                    </div>
                  )}
                  <h4 className="text-lg font-semibold text-indigo-700">{job.companyId.name}</h4>
                  <p className="text-gray-600 mt-1 text-sm">{job.companyId.industry}</p>
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <span>{job.companyId.location?.city}, {job.companyId.location?.state}, {job.companyId.location?.country}</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-600">
                      <svg className="w-5 h-5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
        ...
        <div className="w-full md:w-1/3 space-y-6">
          ...
          >
            ...
            <p className="text-blue-100 mb-4">
              Submit your application quickly for this {job.title} role at {job.companyId?.name}
            </p>
            ...
            <div className="bg-white bg-opacity-10 rounded-lg p-4 mb-4">
              ...
              <div className="w-full bg-blue-800 bg-opacity-40 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${Math.min(100, (job.applicants / 50) * 100)}%` }}
                ></div>
              </div>
            </div>
            ...
            {hasApplied ? (
              <div className="bg-green-500 bg-opacity-20 border border-green-300 rounded-lg p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-blue-200">Keep an eye on your email for updates</div>
                </div>
              </div>
            ) : (
              <button 
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2">
                ...
                <button className="bg-white bg-opacity-10 hover:bg-opacity-20 p-2 rounded-lg transition-all duration-300" onClick={shareJob}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"></path>
                  </svg>
                </button>
          ...
          >
            ...
            <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-900">{formatSalary(job.min_salary, job.max_salary)}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-gray-500 text-sm">Application Deadline</div>
                  <div className="font-medium text-gray-900">{formatDate(job.applicationDeadline)}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-900">{job.location.city}, {job.location.state}</div>
                </div>
              </div>
          ...
          >
            ...
            <p className="text-gray-500 text-sm mb-4">Here are some similar opportunities based on your profile</p>
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4 hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300 cursor-pointer">
                <h4 className="font-semibold text-indigo-700">Senior Frontend Developer</h4>
                <p className="text-sm text-gray-600">TechCorp Inc • Remote</p>
                <div className="flex justify-between items-center mt-2">
                  <span className="text-sm font-medium text-gray-900">$95k - $120k</span>
                  <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">New</span>
                </div>
              </div>
              
              <div className="border border-gray-200 rounded-lg p-4 hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300 cursor-pointer">
                <h4 className="font-semibold text-indigo-700">Backend Engineer</h4>
                <p className="text-sm text-gray-600">DataSystems Ltd • Chicago, IL</p>
                <div className="flex justify-between items-center mt-2">
                  <span className="text-sm font-medium text-gray-900">$110k - $135k</span>
                  <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full">3 days ago</span>
                </div>
              </div>
              
              <div className="border border-gray-200 rounded-lg p-4 hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300 cursor-pointer">
                <h4 className="font-semibold text-indigo-700">Full Stack Developer</h4>
                <p className="text-sm text-gray-600">InnovateSoft • Hybrid</p>
                <div className="flex justify-between items-center mt-2">
                  <span className="text-sm font-medium text-gray-900">$85k - $115k</span>
                  <span className="text-xs bg-indigo-100 text-indigo-800 px-2 py-1 rounded-full">1 week ago</span>
                </div>
              </div>
            </div>
            
            <a href="/jobs/search" className="mt-4 text-indigo-600 hover:text-indigo-800 inline-flex items-center gap-1 text-sm font-medium">
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-700">Tailor your resume to highlight relevant {job.skills.join(", ")} experience</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span className="text-gray-700">Research {job.companyId?.name || "the company"} before your interview</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span className="text-gray-700">Prepare examples of your experience with {job.skills.slice(0, 3).join(", ")}</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span className="text-gray-700">Follow up within 48 hours after your interview</span>
              </li>
            </ul>
            <a 
          ...
          >
            <h3 className="text-lg font-bold text-indigo-800 mb-3">Need help with your resume?</h3>
            <p className="text-indigo-600 text-sm mb-4">Download our expert resume template designed for {job.title} roles</p>
            <button 
              className="w-full bg-white text-indigo-700 hover:text-indigo-800 border border-indigo-200 font-medium py-2.5 px-4 rounded-lg shadow hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
